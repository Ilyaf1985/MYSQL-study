...
--
-- Temporary view structure for view `count_message`
--

DROP TABLE IF EXISTS `count_message`;
/*!50001 DROP VIEW IF EXISTS `count_message`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `count_message` AS SELECT 
 1 AS `affiliate`,
 1 AS `Количество сообщений`*/;
...
INSERT INTO `departments_employees` VALUES (1,1,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(2,2,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(2,3,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(2,4,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(3,5,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(3,6,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(3,7,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(3,8,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(3,42,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(4,9,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(4,10,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(4,13,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(5,11,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(5,12,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(5,14,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(6,15,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(7,16,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(7,17,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(7,18,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(8,19,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(8,20,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(8,21,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(8,22,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(9,23,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(9,24,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(9,25,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(10,26,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(10,27,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(10,28,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(11,29,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(12,30,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(12,31,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(12,32,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(13,33,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(13,34,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(13,35,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(14,36,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(14,37,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(14,38,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(15,39,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(15,40,'2021-10-18 16:32:14','2021-10-18 16:32:14'),(15,41,'2021-10-18 16:32:14','2021-10-18 16:32:14');
...
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Таблица сотрудников';
/*!40101 SET character_set_client = @saved_cs_client */;
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `check_age` BEFORE INSERT ON `employees` FOR EACH ROW BEGIN
...
--
-- Temporary view structure for view `employees_barcelona`
--

DROP TABLE IF EXISTS `employees_barcelona`;
/*!50001 DROP VIEW IF EXISTS `employees_barcelona`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `employees_barcelona` AS SELECT 
 1 AS `Имя`,
 1 AS `birthday`,
 1 AS `gender`,
 1 AS `city`,
...
--
-- Temporary view structure for view `employees_milan`
--

DROP TABLE IF EXISTS `employees_milan`;
/*!50001 DROP VIEW IF EXISTS `employees_milan`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `employees_milan` AS SELECT 
 1 AS `Имя`,
 1 AS `birthday`,
 1 AS `gender`,
 1 AS `city`,
...
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Список телефонных номеров';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Final view structure for view `count_message`
--
...
/*!50001 VIEW `count_message` AS select `employees`.`affiliate` AS `affiliate`,count(0) AS `Количество сообщений` from ((`messages` join `employees` on(((`messages`.`from_employee_id` = `employees`.`id`) or (`messages`.`to_employee_id` = `employees`.`id`)))) join `affiliates` on((`affiliates`.`id` = `employees`.`affiliate`))) group by `employees`.`affiliate` order by count(0) desc */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `employees_barcelona`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `employees_barcelona` AS select concat(`employees`.`first_name`,' ',`employees`.`last_name`) AS `Имя`,`employees`.`birthday` AS `birthday`,`employees`.`gender` AS `gender`,`profiles`.`city` AS `city`,`profiles`.`country` AS `country`,(select `hobbies`.`name` from `hobbies` where (`hobbies`.`id` = `hobbies_employees`.`hobbies_id`)) AS `Хобби`,`profiles`.`about_yourself` AS `О себе` from ((`employees` join `profiles` on((`profiles`.`employee_id` = `employees`.`id`))) join `hobbies_employees` on((`hobbies_employees`.`employee_id` = `employees`.`id`))) where (`employees`.`affiliate` = (select `affiliates`.`id` from `affiliates` where (`affiliates`.`city` = 'Barcelona'))) order by 'Имя' desc,'Хобби' */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `employees_milan`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `employees_milan` AS select concat(`employees`.`first_name`,' ',`employees`.`last_name`) AS `Имя`,`employees`.`birthday` AS `birthday`,`employees`.`gender` AS `gender`,`profiles`.`city` AS `city`,`profiles`.`country` AS `country`,(select `hobbies`.`name` from `hobbies` where (`hobbies`.`id` = `hobbies_employees`.`hobbies_id`)) AS `Хобби`,`profiles`.`about_yourself` AS `О себе` from ((`employees` join `profiles` on((`profiles`.`employee_id` = `employees`.`id`))) join `hobbies_employees` on((`hobbies_employees`.`employee_id` = `employees`.`id`))) where (`employees`.`affiliate` = (select `affiliates`.`id` from `affiliates` where (`affiliates`.`city` = 'Milan'))) order by 'Имя' desc,'Хобби' */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2021-10-21 16:39:18
